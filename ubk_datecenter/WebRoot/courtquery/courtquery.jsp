...
<script type="text/javascript">
	function exportexcel() {
		...
		window.location.href = "./../exportCourtexcel.action?startTime="
...
<body class="easyui-layout">
	...
	<div data-options="region:'center',iconCls:'icon-ok'">
		<table id="mydatagrid">
			<thead>
				<tr>
					<th data-options="field:'announcementType',width:100,align:'left'">公告类型
					</th>
					<th data-options="field:'parties',width:100,align:'left'">当事人</th>
					<th data-options="field:'noticePeople',width:100,align:'left'">法院</th>
					<th data-options="field:'bulletinTime',width:100,align:'center'">公告时间</th>
					<th data-options="field:'content',width:500,align:'center'">公告内容</th>
					<th
						data-options="field:'publishedEdition',width:100,align:'center'">刊登版面</th>
					<th data-options="field:'postingDate',width:100,align:'center'">刊登日期</th>
					<th data-options="field:'area',width:100,align:'center'">地区</th>
				</tr>
			</thead>
		</table>
	</div>
