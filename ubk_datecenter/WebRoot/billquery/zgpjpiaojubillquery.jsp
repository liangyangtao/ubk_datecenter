...
<script type="text/javascript">
	function exportexcel() {
		...
		window.location.href = "./../exportZgpjPiaojuBillExcel.action?startTime="
	...
	$(function() {
		$('#mydatagrid').datagrid({
			...
			nowrap : true,
			striped : true,
			url : './../readZgpjPiaojuBills.action',
			loadMsg : '数据装载中......',
			fitColumns : true,
			remoteSort : false,
			rownumbers : true,
		...
		<table id="mydatagrid">
			<thead>
				<tr>
					...
					<th data-options="field:'proNum',width:100,align:'center'">期数</th>
