...
<script type="text/javascript">
	function exportexcel() {
		...
		window.location.href = "./../exportexcel.action?startTime=" + startTime
				+ "&endTime=" + endTime;
		...
		<table id="mydatagrid">
			<thead>
				<tr>
					...
					<th data-options="field:'billBank',width:100,align:'center'">承兑银行</th>
					<th data-options="field:'publishDate',width:100,align:'center'">发布日期</th>
					<th data-options="field:'publishTime',width:100,align:'center'">发布时间</th>
					<th data-options="field:'billRate',width:100,align:'center'">预期年化收益率</th>
					<th data-options="field:'billMoney',width:100,align:'center'">募集金额</th>
					<th data-options="field:'billDay',width:100,align:'center'">理财期限</th>
				</tr>
			</thead>
		</table>
	</div>
